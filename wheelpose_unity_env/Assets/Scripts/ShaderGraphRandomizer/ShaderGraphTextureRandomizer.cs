...
namespace UnityEngine.Perception.Randomization.Randomizers.SampleRandomizers
{
    ...
    public class ShaderGraphTextureRandomizer : Randomizer
    {
        ...
        /// </summary>
        public CategoricalParameter<Texture2D> albedoTexture;
        public CategoricalParameter<Texture2D> normalTexture;
        public CategoricalParameter<Texture2D>maskTexture;
        public float hueTop = 0.0f;
        public float hueBottom = 0.0f;
        public CategoricalParameter<Material> characterMaterial;
